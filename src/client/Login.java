...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            userAccount = userDao.checkLogin(loginname, password);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        if (userAccount != null) {
            if (userAccount.getStatus() == 1) {
                JOptionPane.showMessageDialog(this, "Account is already login");
            } else {
                new ChattingForm(userAccount).setVisible(true);
